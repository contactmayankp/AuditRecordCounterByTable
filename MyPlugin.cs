...
namespace Sdmsols.XTB.AuditRecordCounterByTable
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "AuditRecordCounterByTable"),
        ExportMetadata("Description", "Get Number of records in Audit table by each Dyanamics 365 Table"),
    ...
    public class MyPlugin : PluginBase,IPayPalPlugin
    {
        ...
        {
            return new AuditRecordCounterByTable();
        }
